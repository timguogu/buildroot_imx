...
prefix_build="/home/peter/buildroot-2020.02.8/output/host"
...
CFLAGS=$(echo "-O2 -I/home/peter/buildroot-2020.02.8/output/host/include" | sed "s#^$prefix_build#$prefix_real#")
VERSION="3.8"
LIBM="-lm"
LIBC=""
SYSLIBS="$LIBM $LIBC"
...
LIBPL=$(echo "$(prefix)/lib/python3.8/config-$(VERSION)$(ABIFLAGS)-x86_64-linux-gnu" | sed "s#^$prefix_build#$prefix_real#")
