...
Currently available applets include:
	...
	basename, bc, blkid, bunzip2, bzcat, cat, chattr, chgrp, chmod,
	chown, chroot, chrt, chvt, cksum, clear, cmp, cp, cpio, crond,
	crontab, cut, date, dc, dd, deallocvt, delgroup, deluser, devmem,
	...
	run-init, run-parts, runlevel, sed, seq, setarch, setconsole,
...
Print crypt(3) hashed PASSWORD
	...
	-m,--method TYPE	des,md5,sha256/512 (default md5)
	-S,--salt SALT
...
tar c|x|t [-hvokO] [-f TARFILE] [-C DIR] [-T FILE] [-X FILE] [--exclude PATTERN]... [FILE]...
