...
set(CMAKE_C_COMPILER "${RELOCATED_HOST_DIR}/bin/arm-none-linux-gnueabihf-gcc")
set(CMAKE_CXX_COMPILER "${RELOCATED_HOST_DIR}/bin/arm-none-linux-gnueabihf-g++")
if(0)
  ...
  set(CMAKE_Fortran_COMPILER "${RELOCATED_HOST_DIR}/bin/arm-none-linux-gnueabihf-gfortran")
endif()
